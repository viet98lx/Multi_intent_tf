...
def train_network(sess, net, train_generator, validate_generator, nb_epoch,
    ...
    for epoch in range(0, nb_epoch):
        ...
        test_imprv_ratio = (test_best_performance[-1] - avg_test_loss) / test_best_performance[-1]
        # if imprv_ratio > epsilon and test_imprv_ratio > epsilon:
        if avg_test_recall > test_best_recall and test_imprv_ratio > epsilon:
            ...
            print("# The validation's loss is improved from " + "{:.8f}".format(test_best_performance[-1]) + \
